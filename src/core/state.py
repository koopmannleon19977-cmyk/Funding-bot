...
# ============================================================
_state_manager: StateManagerInterface | None = None
...
async def _append_to_realized_pnl_csv(trade_data: dict, pnl_data: dict):
    ...
    await asyncio.get_event_loop().run_in_executor(None, lambda: _write_csv_row(file_path, row, file_exists))
...
async def check_total_exposure(x10_adapter, lighter_adapter, new_trade_size=None) -> tuple[bool, Decimal, Decimal]:
