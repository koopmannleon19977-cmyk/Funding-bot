...
class X10WebSocketOrderClient:
    ...
    def __init__(self, config: X10WsOrderConfig | None = None):
    ...
    async def cancel_order(self, order_id: str, market: str | None = None) -> X10WsOrderResponse:
        """
        ...
        message = {"id": req_id, "method": "order.cancel", "params": {"orderId": order_id}}
...
def create_x10_ws_order_client(url: str | None = None, api_key: str | None = None) -> X10WebSocketOrderClient:
