# src/infrastructure/persistence/state_manager.py
...
class InMemoryStateManager:
    ...
    async def close_trade_verified(
        ...
        """
        from src.application.reconciliation import verify_trade_closed_on_exchange
...
async def close_state_manager():
    ...
    """
    global _state_manager, _state_manager_closed
    _state_manager_closed = True  # Mark as closed BEFORE stopping
    if _state_manager:
