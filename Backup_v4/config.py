...
MAX_EXPOSURE_PCT = 0.5              # Max 25% des Gesamtbalances in offenen Trades
...
FARM_NOTIONAL_USD = 25                     # Kleine Positionen für Volumen
FARM_HOLD_SECONDS = 420                    # 7 Minuten halten → dann close (sicher vor Funding-Flip)
FARM_MAX_CONCURRENT = 20                   # Max 20 kleine Farm-Trades gleichzeitig
...
FARM_MAX_SPREAD_PCT = 0.09                 # Sehr enger Spread → fast kein Slippage