...
class ExchangeStats(BaseModel):
    ...
    daily_usd_volume: StrictFloat | StrictInt
        ...
        _obj = cls.model_validate(
            {
                ...
                "total": obj.get("total"),
                "order_book_stats": [OrderBookStats.from_dict(_item) for _item in obj["order_book_stats"]]
                if obj.get("order_book_stats") is not None
                else None,
