...
class RiskInfo(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "cross_risk_parameters": RiskParameters.from_dict(obj["cross_risk_parameters"])
                if obj.get("cross_risk_parameters") is not None
                else None,
                "isolated_risk_parameters": [
                    RiskParameters.from_dict(_item) for _item in obj["isolated_risk_parameters"]
                ]
                if obj.get("isolated_risk_parameters") is not None
                else None,
            }
        )
