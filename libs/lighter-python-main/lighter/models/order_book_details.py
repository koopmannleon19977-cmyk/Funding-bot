        ...
        _obj = cls.model_validate(
            {
                ...
                "order_book_details": [PerpsOrderBookDetail.from_dict(_item) for _item in obj["order_book_details"]]
                if obj.get("order_book_details") is not None
                else None,
                "spot_order_book_details": [
                    SpotOrderBookDetail.from_dict(_item) for _item in obj["spot_order_book_details"]
                ]
                if obj.get("spot_order_book_details") is not None
                else None,
            }
        )
