...
class AccountMarketStats(BaseModel):
    ...
    weekly_base_token_volume: StrictFloat | StrictInt
    weekly_quote_token_volume: StrictFloat | StrictInt
    monthly_trades_count: StrictInt
    monthly_base_token_volume: StrictFloat | StrictInt
    monthly_quote_token_volume: StrictFloat | StrictInt
    total_trades_count: StrictInt
    total_base_token_volume: StrictFloat | StrictInt
    total_quote_token_volume: StrictFloat | StrictInt
