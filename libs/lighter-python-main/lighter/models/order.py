...
class Order(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('limit', 'market', 'stop-loss', 'stop-loss-limit', 'take-profit', 'take-profit-limit', 'twap', 'twap-sub', 'liquidation')"
            )
        return value
    ...
    def time_in_force_validate_enum(cls, value):
        ...
        if value not in set(["good-till-time", "immediate-or-cancel", "post-only", "Unknown"]):
            raise ValueError(
                "must be one of enum values ('good-till-time', 'immediate-or-cancel', 'post-only', 'Unknown')"
            )
        return value
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('in-progress', 'pending', 'open', 'filled', 'canceled', 'canceled-post-only', 'canceled-reduce-only', 'canceled-position-not-allowed', 'canceled-margin-not-allowed', 'canceled-too-much-slippage', 'canceled-not-enough-liquidity', 'canceled-self-trade', 'canceled-expired', 'canceled-oco', 'canceled-child', 'canceled-liquidation', 'canceled-invalid-balance')"
            )
        return value
