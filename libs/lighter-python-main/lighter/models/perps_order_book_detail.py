...
class PerpsOrderBookDetail(BaseModel):
    ...
    last_trade_price: StrictFloat | StrictInt
    daily_trades_count: StrictInt
    daily_base_token_volume: StrictFloat | StrictInt
    daily_quote_token_volume: StrictFloat | StrictInt
    daily_price_low: StrictFloat | StrictInt
    daily_price_high: StrictFloat | StrictInt
    daily_price_change: StrictFloat | StrictInt
    open_interest: StrictFloat | StrictInt
    daily_chart: dict[str, StrictFloat | StrictInt]
        ...
        _obj = cls.model_validate(
            {
                ...
                "market_config": MarketConfig.from_dict(obj["market_config"])
                if obj.get("market_config") is not None
                else None,
            }
        )
