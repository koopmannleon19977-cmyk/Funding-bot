...
class Candlestick(BaseModel):
    ...
    timestamp: StrictInt
    open: StrictFloat | StrictInt
    high: StrictFloat | StrictInt
    low: StrictFloat | StrictInt
    close: StrictFloat | StrictInt
    open_raw: StrictFloat | StrictInt
    high_raw: StrictFloat | StrictInt
    low_raw: StrictFloat | StrictInt
    close_raw: StrictFloat | StrictInt
    volume0: StrictFloat | StrictInt
    volume1: StrictFloat | StrictInt
