...
class LiquidationInfo(BaseModel):
    ...
    mark_prices: dict[str, StrictFloat | StrictInt]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "positions": [AccountPosition.from_dict(_item) for _item in obj["positions"]]
                if obj.get("positions") is not None
                else None,
                "risk_info_before": RiskInfo.from_dict(obj["risk_info_before"])
                if obj.get("risk_info_before") is not None
                else None,
                "risk_info_after": RiskInfo.from_dict(obj["risk_info_after"])
                if obj.get("risk_info_after") is not None
                else None,
