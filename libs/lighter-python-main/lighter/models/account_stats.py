        ...
        _obj = cls.model_validate(
            {
                ...
                "cross_stats": AccountMarginStats.from_dict(obj["cross_stats"])
                if obj.get("cross_stats") is not None
                else None,
                "total_stats": AccountMarginStats.from_dict(obj["total_stats"])
                if obj.get("total_stats") is not None
                else None,
            }
        )
