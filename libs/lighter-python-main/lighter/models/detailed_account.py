...
class DetailedAccount(BaseModel):
    ...
    available_balance: StrictStr | None
    status: StrictInt
        ...
        _obj = cls.model_validate(
            {
                ...
                "assets": [AccountAsset.from_dict(_item) for _item in obj["assets"]]
                ...
                "shares": [PublicPoolShare.from_dict(_item) for _item in obj["shares"]]
