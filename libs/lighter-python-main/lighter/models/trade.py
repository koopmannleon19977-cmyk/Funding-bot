...
class Trade(BaseModel):
    ...
    timestamp: StrictInt
    taker_fee: StrictInt | None
    taker_position_size_before: StrictStr
    taker_entry_quote_before: StrictStr
    taker_initial_margin_fraction_before: StrictInt | None
    taker_position_sign_changed: StrictBool | None
    maker_fee: StrictInt | None
    maker_position_size_before: StrictStr
    maker_entry_quote_before: StrictStr
    maker_initial_margin_fraction_before: StrictInt | None
    maker_position_sign_changed: StrictBool | None
