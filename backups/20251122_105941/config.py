...
# ============================================================
# 0b. BLACKLIST (LOW LIQUIDITY / PROBLEMATIC PAIRS)
# ============================================================
BLACKLIST_SYMBOLS = {
    "AERO-USD",   # Low liquidity, zombie issues
    "MEGA-USD",   # Step size too large
}
...
# ============================================================
# 2a. SMART SIZING PARAMETERS
# ============================================================
# Confidence-Based Position Sizing (Kelly-Lite)
POSITION_SIZE_MULTIPLIERS = {
    "high": 2.0,      # conf >= 0.8: 2x base size
    "medium": 1.5,    # conf >= 0.7: 1.5x base size
    "normal": 1.2,    # conf >= 0.6: 1.2x base size
    "low": 0.8        # conf < 0.6: 0.8x base size
}

# Balance Safety Limits
MAX_POSITION_SIZE_PCT = 0.10  # Max 10% of total balance per trade
MIN_POSITION_SIZE_PCT = 0.02  # Min 2% of total balance per trade

# BTC Correlation Thresholds (for confidence boost)
BTC_STRONG_MOMENTUM_PCT = 5.0  # +0.3 confidence
BTC_MEDIUM_MOMENTUM_PCT = 3.0  # +0.2 confidence
BTC_WEAK_MOMENTUM_PCT = 1.5    # +0.1 confidence
...
X10_API_BASE_URL = "https://api.starknet.extended.exchange"  # NEW
