...
class X10Adapter(BaseAdapter):
    ...
    async def start_websocket(self):
        ...
        """
        trades_url = "wss://api.starknet.extended.exchange/stream.extended.exchange/v1/publicTrades"
            orderbook_url = "wss://api.starknet.extended.exchange/stream.extended.exchange/v1/orderBook"  # Capital B
